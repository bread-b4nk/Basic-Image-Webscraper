...
def save_links(titles,links,descriptions,search_query):
    file = open(search_query+".txt","w+")
    for i in range(len(titles)):
        file.write(titles[i]+"\t"+links[i]+"\t"+descriptions[i]+"\n")
    file.close()
    print("Links saved in "+str(search_query)+".txt")
